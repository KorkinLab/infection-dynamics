...
#### Zuiderdam ####
starts = c(S = 2688, I = 14, R = 0) #Based on the fact that Day 2 has 14 symptomatic in CDC report
times  = seq(1, 9, by = 1)
betas = 0.5 #0.75 for 2 days or 0.5 for 3 days
gammas = 0.33 #0.5 for 2 days or 0.33 for 3 days
########
...
output_folder = 'output_sir_shipX_3d.csv' #file with the raw output numbers
