 ...
 * @author Jeffrey
 */
public class StrucCrew extends Person 
{
    public StrucCrew(Ship state, String personType)
    {
        super(state, personType);
        
        randomness = state.random.nextDouble()*2 - 1;
        
        int workOrSleep = state.random.nextInt(state.numStrucCrew);
        ...
        for(int i = 0; i < 24; i++) //Behavior patterns for agents
        {
            ...
            {
                case 0:
                    if(workOrSleep <= state.numStrucCrew/20)
                        behavior[i] = "Sleep";
                    else
                        behavior[i] = "Work";
                    break;
                ...
                case 23:
                    ...
                    break;
                default:
                    behavior[i] = "Work";//just in case
            }
        }
    }   
    
    @Override
    protected String getAgentType() { return "Crew: Structured"; }
}
