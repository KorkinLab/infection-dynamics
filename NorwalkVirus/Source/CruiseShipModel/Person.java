...
//                        if((totalInfected % 10) == 0) {     // Zuiderdam Norwalk virus: 10% have long recovery
//                            ((MasonGeometry)people.objs[i]).addStringAttribute("SHORT_RECOVERY", "no");
//                        }

//                        System.out.println("Shedding value: " + sheddingValue);
//                        System.out.println("Set acquiredViralParticles: " + ((MasonGeometry)people.objs[i]).getDoubleAttribute("ACQUIRED_PARTICLES"));
//                        if(illnessProbability)
//                        {
//                            ((MasonGeometry)people.objs[i]).addIntegerAttribute("ILL", 1);
//                            totalIll++;
//                            if(this.getAgentType().equals("Passenger")) {
//                            	totalPassengersIll++;
//                            }
...
//                    else if( ( (MasonGeometry)people.objs[i]).getIntegerAttribute("INFECTED") == 1
//                            && ( (MasonGeometry)people.objs[i]).getIntegerAttribute("ILL") == 0 )
//                    {
//                        // is already infected, but is not ill, may not yet have immune response
//                        MasonGeometry mg = ( MasonGeometry )people.objs[ i ];
//                        double ti = mg.getIntegerAttribute( "TIME_INFECTED" );
//                        if( ( (state.schedule.getTime() - ti ) / dayInSteps) == incubationPeriod  // has been infected for less than incubation 
//                                && illnessProbability) 
//                        {
//                            (( MasonGeometry )people.objs[i]).addIntegerAttribute( "ILL", 1 );
//                            totalIll++;
