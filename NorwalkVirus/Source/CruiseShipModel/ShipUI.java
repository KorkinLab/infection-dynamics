...
public class ShipUI extends GUIState
{
    ...
    public void init(Controller controller)
    {
        ...
        try {
            ...
            engine.eval(new FileReader("C:/Users/Jmuking/Downloads/VisualSedimentation-master/VisualSedimentation-master/examples/sediclock/sediclock.js"));
        ...
        try {
            Object result = invocable.invokeFunction("initSeconds", null);
        } catch (ScriptException ex) {
            Logger.getLogger(ShipUI.class.getName()).log(Level.SEVERE, null, ex);
    ...
    /*@Override
    public void load(final SimState stateLoc)
    {
        super.load(stateLoc);
        
        //myTimeAttributes.setSeries(((Ship)state).series); //FOR UPDATING LESS OFTEN
        //ChartUtilities.scheduleSeries(this, myTimeAttributes, null); //FOR UPDATING LESS OFTEN
        ...
        ChartUtilities.scheduleSeries(this, myHistoAttributes, null);
    }*/
    ...
    public void setupGUI()
    {
        ...
        /*secondSimPane.addHierarchyBoundsListener(new HierarchyBoundsListener() 
        {
            @Override
            public void ancestorMoved(HierarchyEvent e) {
                secondSimPane.setBounds(displayFrame.getWidth() - displayFrame.getWidth()/40 - displayFrame.getWidth()/4 -
                                        (int)((JScrollPane)display.getComponent(1)).getVerticalScrollBar().getPreferredSize().getWidth(),
                                        display.getHeight() - display.getHeight()/10 - (display.getHeight() - display.getHeight()/5), 
                                        displayFrame.getWidth()/4, 
                                        display.getHeight() - display.getHeight()/5);
                /*secondSimPane.setBounds(0, display.getHeight(), 
                                        displayFrame.getWidth()/4, 
                                        display.getHeight() - display.getHeight()/5);*/
                
                /*myTimeChart.getChartPanel().setPreferredSize(new Dimension(secondSimPane.getWidth(), secondSimPane.getHeight()/3));
                myTimeChart.getChartPanel().setMaximumSize(new Dimension(secondSimPane.getWidth(), secondSimPane.getHeight()/3));
                myHistoChart.getChartPanel().setPreferredSize(new Dimension(secondSimPane.getWidth(), secondSimPane.getHeight()/3));
                myHistoChart.getChartPanel().setMaximumSize(new Dimension(secondSimPane.getWidth(), secondSimPane.getHeight()/3));
            }
        ...
        /*firstSimPane.addHierarchyBoundsListener(new HierarchyBoundsListener() 
        {
            @Override
            public void ancestorMoved(HierarchyEvent e) {
                /*firstSimPane.setBounds(display.getWidth()/40, 
                                       display.getHeight()/10, 
                                       display.getWidth()/5, 
                                       display.getHeight() - display.getHeight()/5);*/
                /*firstSimPane.setBounds(0, display.getHeight(), displayFrame.getWidth(), display.getHeight()/2);
            }
